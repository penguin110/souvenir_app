class Prefecture < ActiveHash::Base
    ...
    self.data = [
        ...
        {id: 4,region_id: 1, name: '宮城県'}, {id: 5,region_id: 1, name: '秋田県'}, {id: 6,region_id: 1, name: '山形県'},
        {id: 7,region_id: 1, name: '福島県'}, {id: 8,region_id: 2, name: '茨城県'}, {id: 9,region_id: 2, name: '栃木県'},
        {id: 10,region_id: 2, name: '群馬県'}, {id: 11,region_id: 2, name: '埼玉県'}, {id: 12,region_id: 2, name: '千葉県'},
        {id: 13,region_id: 2, name: '東京都'}, {id: 14,region_id: 2, name: '神奈川県'}, {id: 15,region_id: 3, name: '新潟県'},
        ...
        {id: 37,region_id: 6, name: '香川県'}, {id: 38,region_id: 6, name: '愛媛県'}, {id: 39,region_id: 6, name: '高知県'},
        {id: 40,region_id: 7, name: '福岡県'}, {id: 41,region_id: 7, name: '佐賀県'}, {id: 42,region_id: 7, name: '長崎県'},
        {id: 43,region_id: 7, name: '熊本県'}, {id: 44,region_id: 7, name: '大分県'}, {id: 45,region_id: 7, name: '宮崎県'},
        {id: 46,region_id: 7, name: '鹿児島県'}, {id: 47,region_id: 7, name: '沖縄県'}
    ]
